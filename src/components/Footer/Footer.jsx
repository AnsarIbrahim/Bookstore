...
const Footer = ({ handleDarkMode, isDarkMode }) => (
  <>
    <div className="fixed bottom-0 z-40 flex h-10 w-full items-center justify-start bg-white shadow  shadow-slate-100 dark:bg-gray-800 sm:h-10">
      <div className=" pl-10">
        {isDarkMode ? (
      ...
      <div className="flex w-full items-center justify-center pr-10">
        ...
        &nbsp;
        <a
          className="text-blue-600/75 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:text-blue-600 motion-reduce:transition-none motion-reduce:hover:transform-none"
